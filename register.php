...
$username_err = $password_err = $confirm_password_err = $user_email_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($user_email_err)){
        ...
        $sql = "INSERT INTO users (username, password,user_email) VALUES (?, ?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sss", $param_username, $param_password,$user_email);
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>Email</label>
                <input type="text" name="user_email" class="form-control <?php echo (!empty($user_email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $user_email; ?>">
